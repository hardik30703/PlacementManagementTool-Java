...
<main>
    <section class="info-section">
        ...
        <ul>
            <li>Submit a student form</li>
            <li>View and track status of application</li>
            <li>Select available time slots for site visits</li>
            <li>Communicate with tutors and providers</li>
        </ul>


        <script>
            // Check if there is a warning message in the session
            <c:if test="${not empty sessionScope.warningMessage}">
            alert('${sessionScope.warningMessage}');
            // Clear the warning message after displaying it
